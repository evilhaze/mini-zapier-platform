...
export default function EditorLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100">
      ...
      <aside className="relative z-10 flex w-14 flex-shrink-0 flex-col items-center gap-4 overflow-visible border-r border-slate-800 bg-slate-950 py-3">
        <Link
          href="/home"
        ...
        <div className="mt-2 flex flex-1 flex-col items-center gap-2.5 text-slate-500">
  ...
  return (
    <Link
      ...
      className={`
        ...
        ${active
          ? 'border-red-500/30 bg-gradient-to-b from-red-500/20 to-slate-900/40 text-slate-50 shadow-[0_10px_24px_-14px_rgba(239,68,68,0.75)] ring-1 ring-red-500/20'
          : 'border-transparent bg-slate-900/55 text-slate-400 hover:border-slate-700 hover:bg-slate-900/70 hover:text-slate-50'
        }
