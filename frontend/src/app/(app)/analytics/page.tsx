...
function KpiCard({
  ...
  return (
    <div
      className={`group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all hover:-translate-y-[1px] hover:shadow-card-hover ${
...
export default function AnalyticsPage() {
  ...
  return (
    <div className="relative space-y-10">
      ...
      <header className="rounded-2xl border border-slate-200/80 bg-white/70 backdrop-blur-sm p-6 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 rounded-2xl border border-slate-200/80 bg-white p-1 shadow-sm">
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <div className="lg:col-span-2 rounded-2xl border border-slate-200/80 bg-white/80 backdrop-blur-sm p-6 shadow-sm hover:shadow-card-hover transition-shadow">
          <div className="flex items-start justify-between gap-3">
            <div>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white/80 backdrop-blur-sm p-6 shadow-sm hover:shadow-card-hover transition-shadow">
          <p className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-400">
            Status breakdown
          </p>
          <p className="mt-2 text-sm text-slate-600">
