      ...
      <section className="rounded-2xl border border-red-100 bg-rose-50/60 px-6 py-6 shadow-sm sm:px-8 sm:py-8 lg:flex lg:items-center lg:justify-between lg:gap-10">
        <div className="max-w-xl">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            ...
            <Link
              href="/workflows"
              className="inline-flex items-center gap-2 rounded-btn border border-red-200 bg-white px-4 py-2.5 text-sm font-medium text-red-700 hover:bg-rose-50"
            >
        ...
        <div className="mt-6 grid w-full max-w-md gap-3 rounded-xl border border-red-100 bg-white/70 p-4 text-sm text-slate-700 lg:mt-0">
          <div className="flex items-start gap-3 rounded-lg bg-rose-50 px-3 py-2.5">
            ...
            <div>
              <p className="font-medium text-slate-900">Monitor executions in real time</p>
          ...
          <div className="flex items-start gap-3 rounded-lg bg-slate-50 px-3 py-2.5">
            ...
            <div>
              <p className="font-medium text-slate-900">Start with a trigger</p>
              <p className="mt-1 text-xs text-slate-500">
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <Link
            ...
            className="group flex flex-col justify-between rounded-xl border border-slate-200/80 bg-white p-4 text-sm shadow-card hover:border-red-200 hover:shadow-card-hover transition-all"
          >
            <div>
