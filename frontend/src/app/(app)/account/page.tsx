  ...
  if (!hydrated) {
    return (
      <div className="space-y-6">
        <div className="h-32 rounded-2xl border border-slate-200/80 bg-white dark:border-slate-800/80 dark:bg-slate-950" />
        <div className="h-48 rounded-2xl border border-slate-200/80 bg-white dark:border-slate-800/80 dark:bg-slate-950" />
      </div>
    );
  }
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0">
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400 dark:text-slate-300">Account</p>
                <h1 className="truncate text-2xl font-semibold tracking-tight text-slate-900 dark:text-slate-50">{displayName}</h1>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-slate-500">
                  <span className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 dark:border-slate-800 dark:bg-slate-900/50 dark:text-slate-200">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-btn border border-slate-200/80 bg-white px-3.5 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-800/80 dark:bg-slate-950 dark:text-slate-200 dark:hover:bg-slate-900"
            >
              Logout
            </button>
          </div>
